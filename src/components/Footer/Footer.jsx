...
import { ReactComponent as IconGeo } from "../../assets/files/icon-geo.svg";
...
export default function Footer() {
    return (
        <footer className="footer">
            <img className="logo footer__logo" src={logo_footer} alt="logo" />
            ...
            <div className="menu footer__menu">
                <Link to={""} className="menu__link footer__link">
                    <span className="footer__text footer__text_bold footer__text_fs-14">
                        Каталог товаров
                    </span>
                </Link>
                ...
                >
                    <span className="footer__text">Трековые светильники</span>
                </Link>
                <Link
                    to={""}
                ...
                <Link
                    ...
                    className="menu__link footer__link footer__link_hover-ul"
                >
                    <span className="footer__text">Профильные светильники</span>
                </Link>
                <Link
                    to={""}
                    className="menu__link footer__link footer__link_hover-ul"
                >
                    <span className="footer__text">Фигурные светильники</span>
                </Link>
                <Link
                    to={""}
                    className="menu__link footer__link footer__link_hover-ul"
                >
                    <span className="footer__text">Светильники Армстронг</span>
                </Link>
                <Link
                    to={""}
                    className="menu__link footer__link footer__link_hover-ul"
            ...
            <div className="menu footer__menu">
                ...
                <Link to={""} className="menu__link footer__link ">
                    <span className="footer__text footer__text_bold">FAQ</span>
                </Link>
            </div>
            <div className="menu footer__menu">
                <p className="footer__text footer__text_bold footer__text_fs-14">
                    Контакты
                </p>
                <Link to={"/"} className="menu__link footer__link">
                    <IconGeo className="menu__link-icon" />
                    <span className="footer__text footer__text_fs-14">
                        место магазина
                    </span>
                </Link>
                <Link to={"/"} className="menu__link footer__link">
